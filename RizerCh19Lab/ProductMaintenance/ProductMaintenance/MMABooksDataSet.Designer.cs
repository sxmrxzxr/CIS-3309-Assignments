...
SELECT ProductCode, Description, UnitPrice FROM Products WHERE (ProductCode = @ProductCode)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ProductCode, Description, UnitPrice FROM dbo.Products WHERE ProductCode = " +
                "@ProductCode";
        ...
        public virtual int FillByProductCode(MMABooksDataSet.ProductsDataTable dataTable) {
        ...
        public virtual MMABooksDataSet.ProductsDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            MMABooksDataSet.ProductsDataTable dataTable = new MMABooksDataSet.ProductsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
